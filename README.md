...
Pre-built releases are available on the [Releases](https://github.com/LucidByteLabs/CustomsForge-Song-Manager/releases) page:
...
1. Download `CFSMSetup.exe` from [CustomsForge](https://ignition4.customsforge.com/tools/cfsm#downloads) or from this repo's [Releases](https://github.com/LucidByteLabs/CustomsForge-Song-Manager/releases)
